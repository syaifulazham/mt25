...
export const templateQuerySchema = z.object({
  ...
  targetType: z.string().nullable().optional().refine((val) => !val || ['GENERAL', 'EVENT_PARTICIPANT', 'EVENT_WINNER', 'NON_CONTEST_PARTICIPANT', 'QUIZ_PARTICIPANT', 'QUIZ_WINNER', 'TRAINERS'].includes(val), {
    message: 'Invalid target type'
  }),
})

// Target audience type enum
export const targetTypeEnum = z.enum(['GENERAL', 'EVENT_PARTICIPANT', 'EVENT_WINNER', 'NON_CONTEST_PARTICIPANT', 'QUIZ_PARTICIPANT', 'QUIZ_WINNER', 'TRAINERS'])
