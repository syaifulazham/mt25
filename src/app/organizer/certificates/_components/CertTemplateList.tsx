          ...
          {paginatedGroupKeys.map(targetType => (
            ...
            <div key={template.id} className="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-4">
                ...
                {/* Generate Button for CONTINGENT templates */}
                {template.targetType === 'CONTINGENT' && canCreateTemplate && (
                  <div className="mt-3">
                    <Link
                      href={`/organizer/certificates/templates/${template.id}/generate-contingent`}
                ...
                {/* Manage Trainers Button for TRAINERS templates */}
                {template.targetType === 'TRAINERS' && canCreateTemplate && (
                  <div className="mt-3">
                    <Link
                      href={`/organizer/certificates/templates/${template.id}/trainers`}
                      className="w-full inline-flex justify-center items-center px-4 py-2 bg-orange-600 text-white text-sm font-medium rounded-md hover:bg-orange-700 transition-colors"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                      </svg>
