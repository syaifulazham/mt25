#!/bin/bash
# Script to test the school-category API endpoint with different state IDs

# Base URL - change if needed
BASE_URL="http://localhost:3000"
ENDPOINT="/api/dashboard/school-category"
...
echo -e "${BLUE}===== Testing School Category API =====${NC}"
