#!/bin/bash
# Script to test the gender-distribution API endpoint with different state IDs

# Base URL - change if needed
BASE_URL="http://localhost:3000"
ENDPOINT="/api/dashboard/gender-distribution"
...
echo -e "${BLUE}===== Testing Gender Distribution API =====${NC}"
